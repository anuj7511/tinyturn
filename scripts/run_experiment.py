...
Usage:
  python scripts/run_experiment.py B0 --context-s 4.0
  python scripts/run_experiment.py B1 --context-s 4.0
  python scripts/run_experiment.py B1-f0 --context-s 4.0
"""
import argparse
import sys
