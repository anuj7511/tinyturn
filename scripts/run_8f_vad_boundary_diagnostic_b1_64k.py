...
Usage:
  python scripts/run_8f_vad_boundary_diagnostic_b1_64k.py
  python scripts/run_8f_vad_boundary_diagnostic_b1_64k.py --refresh-boundaries  # force recompute
"""
import argparse
import json
import sys
...
from scripts.run_metric_audit import (
