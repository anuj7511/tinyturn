...
Motivation: 8g's "safety-critical flip rate" (qualify_teacher_a0_ci_gated.py::direction_specific_gates)
...
No new inference: reuses the per-clip probabilities already saved by vad_boundary_diagnostic_full_val.py
for A0 (original + boundary-robust remediation) and B1@1s.

Usage:
  python scripts/ground_truth_conditioned_metric_audit.py
"""
import json
import sys
