...
Usage:
  python scripts/build_data_scale_tier.py [--limit-per-shard N] [--shards 10,20,30,40,50]
"""
import argparse
import io
import time
...
# ---- verbatim compute_signal_features_v3 (copied from scripts/decode_and_transcribe_train_sample.py,
