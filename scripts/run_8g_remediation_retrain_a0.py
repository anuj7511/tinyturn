...
Usage:
  python scripts/run_8g_remediation_retrain_a0.py [--force]
"""
import sys
...
def main():
    ...
    print(
        ...
        f"  python scripts/run_8e_padding_counterfactual.py {OUT_DIR}\n"
        f"  python scripts/run_8f_vad_boundary_diagnostic_v2.py {OUT_DIR}\n"
        f"  python scripts/run_8g_qualify_teacher_v2.py {OUT_DIR}\n"
