...
Usage:
  python scripts/run_step10_64k_baseline.py               # seed 42 (already run)
  python scripts/run_step10_64k_baseline.py --seed 43
  python scripts/run_step10_64k_baseline.py --seed 44
"""
import argparse
import sys
