...
D6 (`d6_context_probe.py`) is population-wide (mixes real+synthetic), sweeps 1/2/4/6/8s, and
...
Reuses `segment_runs` / `slope_in_window` from d6_context_probe.py verbatim (same threshold
