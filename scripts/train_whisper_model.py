"""CLI entry point for A0 (Whisper-Tiny baseline) training. Separate from train_mel_trajectory_model.py because
it drives tinyturn.train_whisper rather than tinyturn.train (different dataset/model, same protocol).

Usage:
  python scripts/train_whisper_model.py --context-s 4.0 --epochs 2
"""
import argparse
import sys
