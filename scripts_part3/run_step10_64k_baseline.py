...
(28,114 -> ~61k clips, via `build_32k_scale_tier.py --shards 5,15,25,35,45,55,60,65,70,75,80`). Fixed
val/calib splits are untouched throughout.

Usage:
  python scripts_part3/run_step10_64k_baseline.py               # seed 42 (already run)
  python scripts_part3/run_step10_64k_baseline.py --seed 43
  python scripts_part3/run_step10_64k_baseline.py --seed 44
"""
import argparse
import sys
