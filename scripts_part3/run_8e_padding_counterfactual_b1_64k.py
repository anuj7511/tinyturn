...
Whisper). Same method as `run_8e_padding_counterfactual.py`: take val clips short enough to need
...
Usage:
  python scripts_part3/run_8e_padding_counterfactual_b1_64k.py
"""
import json
import sys
...
from scripts_part3.run_8f_vad_boundary_diagnostic_b1_64k import (
