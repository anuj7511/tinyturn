...
pause-event balance). Originally seed 42 only, run after run_step10_64k_baseline.py cleared the
...
Usage:
  python scripts_part3/run_step10_64k_lambda0.5_5050.py               # seed 42 (already run)
  python scripts_part3/run_step10_64k_lambda0.5_5050.py --seed 43
  python scripts_part3/run_step10_64k_lambda0.5_5050.py --seed 44
"""
import argparse
import sys
...
def main():
    ...
    if not baseline_checkpoint.exists():
        print(f"ERROR: {baseline_checkpoint} not found -- run run_step10_64k_baseline.py "
