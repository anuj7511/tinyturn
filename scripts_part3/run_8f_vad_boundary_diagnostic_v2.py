...
Boundary estimators:
  ...
  - alt_threshold: a genuinely different fixed-threshold energy detector (median-based noise floor
    ...
    this working tree (that pilot's generating script lived outside scripts_part3) -- this is a new,
...
Usage:
  python scripts_part3/run_8f_vad_boundary_diagnostic_v2.py
"""
import json
import sys
import time
...
# remediation rerun must point it there explicitly too (see run_8g_qualify_teacher_v2.py's own
# sys.argv[1] override).
