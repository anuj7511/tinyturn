...
Usage:
  python scripts_part3/build_32k_scale_tier.py [--limit-per-shard N] [--shards 10,20,30,40,50]
"""
import argparse
import io
import time
...
# ---- verbatim compute_signal_features_v3 (copied from scripts_part3/d2_decode_transcribe.py,
