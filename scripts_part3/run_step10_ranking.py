...
Usage:
  python scripts_part3/run_step10_ranking.py                      # seed 42, fixed 5-epoch protocol
  python scripts_part3/run_step10_ranking.py --seed 43 --plateau  # 3-seed confirmation (step 5),
