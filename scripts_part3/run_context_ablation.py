...
Usage:
  python scripts_part3/run_context_ablation.py B1 --context-s 1.0
  python scripts_part3/run_context_ablation.py B1 --context-s 2.0
  python scripts_part3/run_context_ablation.py A0 --context-s 2.0
  python scripts_part3/run_context_ablation.py A0 --context-s 8.0
"""
import argparse
import sys
