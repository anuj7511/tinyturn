...
A new script, `scripts_part3/run_metric_audit.py`, recomputes the same event conditioned on ground
...
distillation alone. A control, **D0** (`scripts_part3/run_step10_distill_d0.py`): identical
...
New code: `tinyturn/train_distill.py`, `scripts_part3/precompute_teacher_logits_a0_boundary_robust.py`,
`scripts_part3/run_step10_distill.py`. `tinyturn/dataset.py` gained `augment_boundaries` and
...
`scripts_part3/run_step10_ranking.py`.
...
`scripts_part3/run_matched_recall_audit.py` recomputes this correctly, and also fixes a second,
...
(`scripts_part3/build_32k_scale_tier.py`.)
...
`scripts_part3/build_32k_scale_tier.py` (generalized to accept `--shards` for any tier),
`scripts_part3/run_step10_32k_baseline.py`, `scripts_part3/run_step10_32k_lambda0.5_5050.py`,
`scripts_part3/run_step10_64k_baseline.py`, `scripts_part3/run_step10_64k_lambda0.5_5050.py`.
...
new `scripts_part3/run_8f_vad_boundary_diagnostic_b1_64k.py` (never run for B1 at this data scale
...
`scripts_part3/run_8f_vad_boundary_diagnostic_b1_64k.py`.

**Padding counterfactual (8e-style)**, via the new `scripts_part3/run_8e_padding_counterfactual_b1_64k.py`
...
`scripts_part3/run_8e_padding_counterfactual_b1_64k.py`.
...
New `scripts_part3/run_temperature_scaling_64k.py`. Verified explicitly, not assumed: temperature
...
Artifacts: `experiments/temperature_scaling_64k.json`, `scripts_part3/run_temperature_scaling_64k.py`.
...
**Official test evaluation** (new `scripts_part3/run_official_test_evaluation.py`, three phases —
...
**Export**: `scripts_part3/run_frozen_export.py` — FP32 ONNX (474,165 bytes) and INT8 dynamic-
...
`scripts_part3/run_official_test_evaluation.py`, `scripts_part3/run_frozen_export.py`.
...
- New code: `scripts_part3/run_metric_audit.py`, `scripts_part3/precompute_teacher_logits_a0_boundary_robust.py`,
  `tinyturn/train_distill.py`, `scripts_part3/run_step10_distill.py`, `tinyturn/train_ranking.py`,
  `scripts_part3/run_step10_ranking.py`, `scripts_part3/run_step10_lambda05_seed42_plateau.py`,
  `scripts_part3/run_matched_recall_audit.py`.
